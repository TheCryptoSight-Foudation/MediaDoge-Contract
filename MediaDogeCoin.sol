...
contract MEDIADOGE is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public safeManager;
    address payable public marketingAddress =
        payable(0x288D830DF0ed68DA7DD0736d2DFff2a50B6aa1AF); // Marketing Address
    ...
    string private _name = "MEDIA DOGE Coin";
    string private _symbol = "MEDIADOGE";
